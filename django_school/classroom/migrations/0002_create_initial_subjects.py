...
def create_subjects(apps, schema_editor):
    ...
    Subject.objects.create(name='Science', color='#343a40')
    Subject.objects.create(name='English', color='#007bff')
    Subject.objects.create(name='Math', color='#28a745')
    Subject.objects.create(name='2nd language', color='#17a2b8')
    Subject.objects.create(name='Social', color='#ffc107')
